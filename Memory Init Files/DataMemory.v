        ...
        if (MemWrite) begin
            if(MemWrite_S == 0)
    			...
    			if (Address[1:0] == 0) //We must deal with the byte addressing. 
    				memory[Address[12:2]][7:0] <= WriteData[7:0];
    			else if (Address[1:0] == 1)
    				memory[Address[12:2]][15:8] <= WriteData[7:0];
    			else if (Address[1:0] == 2)
    				memory[Address[12:2]][23:16] <= WriteData[7:0];
    			else //Otherwise it must be 3. 
    				memory[Address[12:2]][31:17] <= WriteData[7:0];
    		end
    		else if(MemWrite_S == 2) begin
    			if(Address[1] == 0)
    				memory[Address[12:2]][15:0] <= WriteData[15:0];
    			else
    				memory[Address[12:2]][31:16] <= WriteData[15:0];
    		end
        end
    end
